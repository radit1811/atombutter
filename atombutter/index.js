...
client.once('ready', () => {
    ...
    setInterval(() => {
        const channel = client.channels.cache.get('1340595682347843649'); // Ganti dengan ID Channel yang sesuai
...
const rest = new discord.REST({ version: '10' }).setToken('OTU4MTg4NzgwOTUzNjk4Mzk1.G2lknq.oj3GhcLlzA8lFQ5Knk1KVzhrd6T1HWasxUSfMM');

async function refreshCommands() {
    try {
        console.log('Started refreshing application (/) commands.');

        await rest.put(discord.Routes.applicationCommands('958188780953698395'), { body: commands });
...
client.login('OTU4MTg4NzgwOTUzNjk4Mzk1.G2lknq.oj3GhcLlzA8lFQ5Knk1KVzhrd6T1HWasxUSfMM');